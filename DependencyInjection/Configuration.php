        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('base_template')
                    ->defaultValue('two_sidebars')
                    ->validate()
                        ->ifNotInArray(array('two_sidebars', 'one_sidebar', 'full_width'))
                ...
                ->arrayNode('left_sidebar')
                    ->children()
                        ...
                        ->scalarNode('behavior')
                            ->defaultValue('slider')
                            ->validate()
                                ->ifNotInArray(array('slider', 'accordeon'))
                                ->thenInvalid('Behavior can be "slider" or "accordeon", got "%s"')
                            ->end()
                        ->end()
                    ->end()
                ->end()
