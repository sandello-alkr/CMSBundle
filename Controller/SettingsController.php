...
use alkr\CMSBundle\Entity\Settings;
use alkr\CMSBundle\Form\SettingsType;
...
class SettingsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CMSBundle:Settings')->findAll();
     ...
     *
     * @Route("/", name="admin_settings_create")
     * @Method("POST")
     * @Template("CMSBundle:Settings:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CMSBundle:Settings')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CMSBundle:Settings:edit.html.twig")
     */
